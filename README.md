# QA Automation Control Plane API

Jade Global — **qa-automation** domain (QA)

## OpenAPI Spec

The canonical spec lives at [`openapi/qa-automation-control-plane-api.yaml`](openapi/qa-automation-control-plane-api.yaml).
...
```bash
docker build -t jade-qa-automation-control-plane-api:latest k8s/mock-service/
```
